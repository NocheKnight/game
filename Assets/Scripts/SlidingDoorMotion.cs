...
{
    [Header("Настройки раздвижной двери")]
    [SerializeField] private string _openParameterName = "OpenSlideDoor";
    ...
    private void Awake()
    {
        ...
        if (_animator == null)
        {
            Debug.LogError($"SlidingDoorMotion: Animator не найден на {gameObject.name}");
        }
    }
